...
func (c CommandControl) SetModelSlotConfig(cfg core.ModelSlotConfig, actor string, reason string) (core.ModelSlotStatus, error) {
	if c.Runtime == nil {
		return core.ModelSlotStatus{}, fmt.Errorf("runtime is not configured")
	}
	return c.Runtime.SetModelSlotOverride(cfg, actor, reason)
}
